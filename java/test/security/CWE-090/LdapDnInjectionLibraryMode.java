// Fixture for ldap-dn-injection-library-mode. The login principal enters as a
...
public class LdapDnInjectionLibraryMode {
  ...
  public void bindBad(AuthenticationToken token) {
  ...
  public void bindBadLiteralKey(UsernamePasswordToken token) {
  ...
  public LdapContext queryBad(LdapContextFactory factory, AuthenticationToken token)
  ...
  public Object lookupBad(Context ctx, AuthenticationToken token) throws NamingException {
    String dn = getUserDn((String) token.getPrincipal());
